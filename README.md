...
**1.** Locate your Orange installation's widget folder. Usually at:
...
**2.** Copy `owscatterplot3d.py` into this folder.
将 owscatterplot3d.py 文件复制到该文件夹中。

**3.** Copy `ScatterPlot3D.svg` into the icons subdirectory.
将 ScatterPlot3D.svg 拖入 `site-packages/Orange/widgets/visualize/icons` 文件夹中。

**4.** Restart Orange Canvas.
重启 Orange 软件。

**5.** Find 3D Scatter Plot in the Visualize category.
